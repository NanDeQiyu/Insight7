"""Signal alignment tests — Insight vs SciPy on CPU.

Run with:
    PYTHONPATH=bindings/python:build/bindings/python python -m pytest tests/python_align/cpu/test_signal.py -v
"""
