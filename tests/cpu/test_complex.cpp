...
TEST_F(ComplexTest, AsComplexShape) {
  ...
  std::vector<float> data = {1, 4, 2, 5, 3, 6, 7, 10, 8, 11, 9, 12};
...
TEST_F(ComplexTest, AsComplexDtype) {
  std::vector<double> data = {1, 4, 2, 5, 3, 6, 7, 10, 8, 11, 9, 12};
  Array x = to_array(data, Shape({2, 3, 2}));
...
TEST_F(ComplexTest, AsRealRoundTrip) {
  std::vector<float> original_data = {1, 4, 2, 5, 3, 6, 7, 10, 8, 11, 9, 12};
