...
--   LD_LIBRARY_PATH=build/backends/cpu ~/.luarocks/bin/busted tests/cpu/lua/test_signal_convolution.lua

describe("Signal Convolution CPU Tests", function()
  local ins
  setup(function()
    ins = require("insight")
  end)
  ...
  it("fftconvolve_full", function()
    ...
    -- [1, 3, 5, 3]
    assert.near(1.0, c:item(0), 1e-10)
    assert.near(3.0, c:item(1), 1e-10)
    assert.near(5.0, c:item(2), 1e-10)
    assert.near(3.0, c:item(3), 1e-10)
  end)
  ...
  it("fftconvolve_same", function()
    ...
    -- [3, 6, 9, 12, 9]
    assert.near(3.0, c:item(0), 1e-10)
    assert.near(6.0, c:item(1), 1e-10)
    assert.near(9.0, c:item(2), 1e-10)
    assert.near(12.0, c:item(3), 1e-10)
    assert.near(9.0, c:item(4), 1e-10)
  end)
  ...
  it("fftconvolve_valid", function()
    ...
    -- [6, 9, 12]
    assert.near(6.0, c:item(0), 1e-10)
    assert.near(9.0, c:item(1), 1e-10)
    assert.near(12.0, c:item(2), 1e-10)
  end)
  ...
  it("fftconvolve_commutative", function()
    ...
    for i = 0, c1.numel - 1 do
      assert.near(c1:item(i), c2:item(i), 1e-10)
    end
  end)
  ...
  it("fftconvolve_impulse", function()
    ...
    assert.are.equal(5, c.numel)
    for i = 0, 4 do
      assert.near(i + 1.0, c:item(i), 1e-10)
    end
  end)
  ...
  it("correlate_autocorrelation", function()
    ...
    assert.are.equal(5, c.numel)
    assert.near(-1.0, c:item(0), 1e-10)
    assert.near(2.0, c:item(2), 1e-10)
    assert.near(-1.0, c:item(4), 1e-10)
  end)
  ...
  it("correlation_lags_full", function()
    ...
    assert.near(-2.0, lags:item(0), 1e-10)
    assert.near(4.0, lags:item(6), 1e-10)
  end)
  ...
  it("correlation_lags_same", function()
    ...
    assert.near(-1.0, lags:item(0), 1e-10)
    assert.near(3.0, lags:item(4), 1e-10)
  end)
end)
