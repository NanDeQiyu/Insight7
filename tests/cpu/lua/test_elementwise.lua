...
--   LD_LIBRARY_PATH=build/backends/cpu ~/.luarocks/bin/busted tests/cpu/lua/test_elementwise.lua

describe("Elementwise CPU Tests", function()
  local ins
  setup(function()
  ...
  it("add", function()
    ...
    local b = ins.from_table({ 5.0, 4.0, 3.0, 2.0, 1.0 })
    local c = ins.add(a, b)
    assert.is_not_nil(c)
  ...
  it("pow", function()
    local a = ins.from_table({ 2.0, 3.0, 4.0 })
    local b = ins.from_table({ 3.0, 2.0, 0.5 })
    local c = ins.pow(a, b)
    assert.is_not_nil(c)
    assert.are.equal(3, c.numel)
  end)
  ...
  it("mod", function()
    local a = ins.from_table({ 10.0, 7.0, 5.0 })
    local b = ins.from_table({ 3.0, 2.0, 3.0 })
    local c = ins.mod(a, b)
    assert.is_not_nil(c)
    assert.are.equal(3, c.numel)
  end)
  ...
  it("maximum", function()
    ...
    local b = ins.from_table({ 4.0, 2.0, 6.0 })
