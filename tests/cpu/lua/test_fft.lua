...
describe("FFT CPU Tests", function()
  ...
  it("fftshift", function()
    ...
    assert.are.equal(6.0, y[2]:item())
    assert.are.equal(7.0, y[3]:item())
    assert.are.equal(8.0, y[4]:item())
    assert.are.equal(1.0, y[5]:item())
    assert.are.equal(2.0, y[6]:item())
    assert.are.equal(3.0, y[7]:item())
    assert.are.equal(4.0, y[8]:item())
  end)
