...
describe("Audio CPU Tests", function()
  ...
  -- Platform-agnostic temp path helper
  local function tmpath(suffix)
    local p = os.tmpname()
    -- os.tmpname returns a valid temp path on both Unix and Windows
    return p .. suffix
  end
  ...
  it("write creates file", function()
    ...
    local path = tmpath("_audio_test.bin")
  ...
  it("write read roundtrip float64", function()
    ...
    local path = tmpath("_audio_f64.bin")
    ins.signal.write_bin(path, a)
  ...
  it("write read roundtrip float32", function()
    ...
    local path = tmpath("_audio_f32.bin")
    ins.signal.write_bin(path, a)
  ...
  it("write read roundtrip int32", function()
    ...
    local path = tmpath("_audio_i32.bin")
    ins.signal.write_bin(path, a)
  ...
  it("write read zeros", function()
    ...
    local path = tmpath("_audio_zeros.bin")
    ins.signal.write_bin(path, a)
    local result = ins.signal.read_bin(path, ins.float64)
    assert.is_not_nil(result)
  ...
  it("write read ones", function()
    ...
    local path = tmpath("_audio_ones.bin")
    ins.signal.write_bin(path, a)
    local result = ins.signal.read_bin(path, ins.float64)
    assert.is_not_nil(result)
  ...
  it("write read negative values", function()
    ...
    local path = tmpath("_audio_neg.bin")
    ins.signal.write_bin(path, a)
    local result = ins.signal.read_bin(path, ins.float64)
    assert.is_not_nil(result)
    assert.are.equal(3, result.numel)
  ...
  it("write read single element", function()
    ...
    local path = tmpath("_audio_single.bin")
    ins.signal.write_bin(path, a)
    local result = ins.signal.read_bin(path, ins.float64)
    assert.is_not_nil(result)
  ...
  it("write read large signal", function()
    ...
    local path = tmpath("_audio_large.bin")
    ins.signal.write_bin(path, a)
    local result = ins.signal.read_bin(path, ins.float64)
    assert.is_not_nil(result)
  ...
  it("write file size correct", function()
    ...
    local path = tmpath("_audio_size.bin")
    ins.signal.write_bin(path, a)
    local f = io.open(path, "r")
  ...
  it("write read overwrite", function()
    ...
    local path = tmpath("_audio_overwrite.bin")
    os.remove(path)
