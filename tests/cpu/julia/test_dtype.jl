# DType CPU tests — aligned with C++ test_dtype.cpp
# Run with:
#   LD_LIBRARY_PATH=build/backends/cpu julia tests/cpu/julia/test_dtype.jl
...
# cast_i64_to_f64
a = Insight.from_data(Int64[100, 200, 300], Insight.int64)
b = Insight.cast(a, Insight.float64)
...
a = Insight.zeros(Int64[3], Insight.float32)
check("dtype_property_f32", Insight.dtype(a) == Insight.float32)
b = Insight.zeros(Int64[3], Insight.int64)
