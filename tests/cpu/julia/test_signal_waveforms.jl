...
# At 2π - ε, sawtooth ≈ 1.0 (very close but not exact due to floating point)
check("sawtooth_2", approx(Insight.item(y, 2), 1.0, atol=1e-4))
...
check("sawtooth_triangle_1", approx(Insight.item(y, 1), 0.0))
# At π with width=0.5, triangle reaches 1.0
...
# At 2π - ε, square is -1.0 (end of negative half-cycle, boundary case)
