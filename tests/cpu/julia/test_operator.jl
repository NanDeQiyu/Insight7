# Operator CPU tests — aligned with C++ test_operator.cpp
# Run with:
#   LD_LIBRARY_PATH=build/backends/cpu julia tests/cpu/julia/test_operator.jl
...
# indexing via slice
a5 = Insight.from_data([10.0, 20.0, 30.0, 40.0])
# Julia doesn't have direct string indexing, use from_data + reshape
