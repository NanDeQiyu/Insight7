...
def save_plots(r, output_dir="."):
    ...
    ax.pcolormesh(t_spec, f_spec, 10 * np.log10(Sxx.T + 1e-12),
    ...
    ax.imshow(cwt, aspect='auto', cmap='viridis',
              extent=[t[0], t[-1], features["cwt_widths"][-1],
                      features["cwt_widths"][0]])
    ...
    path = os.path.join(output_dir,
                        f"signal_pipeline_{r['device']}.png")
