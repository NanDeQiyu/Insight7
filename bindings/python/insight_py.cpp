  ...
  py::class_<Array>(m, "Array")
      ...
      .def("list", [](const Array &a) {
        ...
        case DType::F64: {
          ...
          for (int64_t i = 0; i < n; i++) result.append(py::float_(d[i]));
          break;
        }
        case DType::F32: {
        ...
        case DType::I64: {
          ...
          for (int64_t i = 0; i < n; i++) result.append(py::int_(d[i]));
          break;
        }
        case DType::I32: {
        ...
        case DType::BOOL: {
          ...
          for (int64_t i = 0; i < n; i++) result.append(py::bool_(d[i]));
          break;
        }
        case DType::C32: {
          const std::complex<float> *d = cpu.data<std::complex<float>>();
          for (int64_t i = 0; i < n; i++)
            result.append(py::cast(std::complex<double>(d[i].real(), d[i].imag())));
          break;
        }
        case DType::C64: {
