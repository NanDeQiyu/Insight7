 ...
 *
 * @param x Input array (real or complex). Complex input must have last
 * dimension size 2.
 * @param n FFT length. If n > input length, zero-padding; if n < input length,
 * truncation. If n == -1, use input length.
 ...
 */
Array fft(const Array &x, int n = -1, int axis = -1,
          const std::string &norm = "backward");

/**
 * @brief 1D inverse discrete Fourier transform.
 */
Array ifft(const Array &x, int n = -1, int axis = -1,
           const std::string &norm = "backward");
 ...
 * @brief 1D real FFT.
 */
Array rfft(const Array &x, int n = -1, int axis = -1,
           const std::string &norm = "backward");

/**
 * @brief 1D inverse real FFT.
 */
Array irfft(const Array &x, int n = -1, int axis = -1,
            const std::string &norm = "backward");
 ...
 */
Array hfft(const Array &x, int n = -1, int axis = -1,
           const std::string &norm = "backward");

/**
 * @brief 1D inverse Hermitian FFT (real input -> complex Hermitian output).
 */
Array ihfft(const Array &x, int n = -1, int axis = -1,
            const std::string &norm = "backward");
