 ...
 */
Array take(const Array &x, const Array &indices,
...
Array scatter_reduce(const Array &x, int dim, const Array &index,
                     const Array &src, const std::string &reduce = "replace");
 ...
 */
inline Array where(const Array &condition) { return nonzero(condition); }
 ...
 */
Array searchsorted(const Array &x, const Array &v,
 ...
 */
UniqueResult unique(const Array &x, bool return_indices = false,
