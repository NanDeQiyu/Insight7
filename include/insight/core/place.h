...
namespace ins {
     ...
     * @param device_type_name Optional name for the device type (e.g., "CUDA", "ROCM")
     */
    void set_device_interface(DeviceKind kind, const C_DeviceInterface* iface, const char* device_type_name);
    ...
    * @brief Get the human-readable name of a device type.
     ...
     * If no interface has been registered for the given device kind, returns "unknown".
     *
