 ...
 * functions to identify which device to operate on.
 */
struct C_Device_st {
...
typedef struct C_DeviceInterface {
   ...
   * @return C_SUCCESS on success, error code otherwise
   */
  C_Status (*device_memory_allocate)(C_Device device, void **ptr, size_t size);
   ...
   * @return C_SUCCESS on success, error code otherwise
   */
  C_Status (*device_memory_deallocate)(C_Device device, void *ptr, size_t size);
   ...
   * @return C_SUCCESS on success, error code otherwise
   */
  C_Status (*host_memory_allocate)(C_Device device, void **ptr, size_t size);
   ...
   * @return C_SUCCESS on success, error code otherwise
   */
  C_Status (*host_memory_deallocate)(C_Device device, void *ptr, size_t size);
   ...
   * @return C_SUCCESS on success, error code otherwise
   */
  C_Status (*memory_copy_h2d)(C_Device device, void *dst, const void *src,
                              size_t size);
   ...
   * @return C_SUCCESS on success, error code otherwise
   */
  C_Status (*memory_copy_d2h)(C_Device device, void *dst, const void *src,
                              size_t size);
   ...
   * @return C_SUCCESS on success, error code otherwise
   */
  C_Status (*memory_copy_d2d)(C_Device device, void *dst, const void *src,
                              size_t size);
   ...
   * @return C_SUCCESS on success, error code otherwise
   */
  C_Status (*memory_copy_p2p)(C_Device dst_device, C_Device src_device,
   ...
   * @return C_SUCCESS on success, error code otherwise
   */
  C_Status (*device_memory_set)(C_Device device, void *ptr, unsigned char value,
                                size_t size);
   ...
   * @return C_SUCCESS on success, error code otherwise
   */
  C_Status (*device_memory_stats)(C_Device device, size_t *total_memory,
                                  size_t *free_memory);
   ...
   * @return C_SUCCESS on success, error code otherwise
   */
  C_Status (*async_memory_copy_h2d)(C_Device device, C_Stream stream, void *dst,
   ...
   * @return C_SUCCESS on success, error code otherwise
   */
  C_Status (*async_memory_copy_d2h)(C_Device device, C_Stream stream, void *dst,
                                    const void *src, size_t size);
   ...
   * @return C_SUCCESS on success, error code otherwise
   */
  C_Status (*async_memory_copy_d2d)(C_Device device, C_Stream stream, void *dst,
                                    const void *src, size_t size);
   ...
   * @return C_SUCCESS on success, error code otherwise
   */
  C_Status (*async_memory_copy_p2p)(C_Device dst_device, C_Device src_device,
                                    C_Stream stream, void *dst, const void *src,
                                    size_t size);
   ...
   * @return C_SUCCESS on success, error code otherwise
   */
  C_Status (*stream_add_callback)(C_Device device, C_Stream stream,
   ...
   * @return C_SUCCESS on success, error code otherwise
   */
  C_Status (*stream_wait_event)(C_Device device, C_Stream stream,
                                C_Event event);
   ...
   * @return C_SUCCESS on success, error code otherwise
   */
  C_Status (*record_event)(C_Device device, C_Stream stream, C_Event event);
   ...
   * @return C_SUCCESS on success, error code otherwise
   */
  C_Status (*profiler_create)(C_Profiler *prof, const char *name,
                              int device_id);
...
typedef struct CustomRuntimeParams {
   ...
   * @return C_SUCCESS on success, error code otherwise
   */
  C_Status (*register_kernel)(const char *op_name, int32_t device_type,
