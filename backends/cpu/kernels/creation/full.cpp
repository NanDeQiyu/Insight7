...
C_Status full_kernel_cpu(void **inputs, void **outputs) {
  ...
  case INSIGHT_DTYPE_BOOL: {
    bool *dst = static_cast<bool *>(out->data) + offset;
  ...
  case INSIGHT_DTYPE_U8: {
    uint8_t *dst = static_cast<uint8_t *>(out->data) + offset;
  ...
  case INSIGHT_DTYPE_I8: {
    int8_t *dst = static_cast<int8_t *>(out->data) + offset;
  ...
  case INSIGHT_DTYPE_I16: {
    int16_t *dst = static_cast<int16_t *>(out->data) + offset;
  ...
  case INSIGHT_DTYPE_I32: {
    int32_t *dst = static_cast<int32_t *>(out->data) + offset;
  ...
  case INSIGHT_DTYPE_I64: {
    int64_t *dst = static_cast<int64_t *>(out->data) + offset;
  ...
  case INSIGHT_DTYPE_U16: {
    uint16_t *dst = static_cast<uint16_t *>(out->data) + offset;
  ...
  case INSIGHT_DTYPE_U32: {
    uint32_t *dst = static_cast<uint32_t *>(out->data) + offset;
  ...
  case INSIGHT_DTYPE_U64: {
    uint64_t *dst = static_cast<uint64_t *>(out->data) + offset;
  ...
  case INSIGHT_DTYPE_F32: {
    float *dst = static_cast<float *>(out->data) + offset;
  ...
  case INSIGHT_DTYPE_C32: {
    std::complex<float> *dst =
        static_cast<std::complex<float> *>(out->data) + offset;
  ...
  case INSIGHT_DTYPE_C64: {
    std::complex<double> *dst =
        static_cast<std::complex<double> *>(out->data) + offset;
  ...
  default:
    cpu_set_last_error(
        ("full_kernel_cpu: unsupported dtype " + std::to_string(dtype))
            .c_str());
    return C_FAILED;
  }
