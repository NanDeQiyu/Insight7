// backends/cpu/kernels/unary/deg2rad.cpp
#include "common.h"
#include <cmath>
...
REGISTER_CPU_KERNEL(deg2rad, INSIGHT_DTYPE_F32, deg2rad_kernel_cpu);
REGISTER_CPU_KERNEL(deg2rad, INSIGHT_DTYPE_F64, deg2rad_kernel_cpu);