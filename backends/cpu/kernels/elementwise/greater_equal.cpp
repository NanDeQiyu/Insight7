...
static inline bool cpu_complex_float_ge(std::complex<float> a, std::complex<float> b) {
    return a.real() >= b.real();
}

static inline bool cpu_complex_double_ge(std::complex<double> a, std::complex<double> b) {
    return a.real() >= b.real();
}
...
REGISTER_CPU_KERNEL(greater_equal, INSIGHT_DTYPE_BOOL, greater_equal_kernel_cpu);
...
REGISTER_CPU_KERNEL(greater_equal, INSIGHT_DTYPE_BF16, greater_equal_kernel_cpu);
