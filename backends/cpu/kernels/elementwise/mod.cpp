...
#include <math.h>
  ...
  */
static inline float cpu_mod_float(float a, float b) {
    return fmodf(a, b);
}
 ...
 */
static inline double cpu_mod_double(double a, double b) {
    return fmod(a, b);
}
...
static void mod_loop_uint8(
    const uint8_t* a_data, const int64_t* a_strides,
...
static void mod_loop_int8(
    const int8_t* a_data, const int64_t* a_strides,
...
static void mod_loop_int16(
    const int16_t* a_data, const int64_t* a_strides,
...
static void mod_loop_int32(
    const int32_t* a_data, const int64_t* a_strides,
...
static void mod_loop_uint16(
    const uint16_t* a_data, const int64_t* a_strides,
...
static void mod_loop_uint32(
    const uint32_t* a_data, const int64_t* a_strides,
...
C_Status mod_kernel_cpu(void** inputs, void** outputs) {
    ...
    switch (a->dtype) {
        case INSIGHT_DTYPE_U8:
            mod_loop_uint8(
                (const uint8_t*)a->data, a_strides,
                (const uint8_t*)b->data, b_strides,
                (uint8_t*)out->data, out_strides,
                ndim, dims, n);
            break;
        case INSIGHT_DTYPE_I8:
            mod_loop_int8(
                (const int8_t*)a->data, a_strides,
                (const int8_t*)b->data, b_strides,
                (int8_t*)out->data, out_strides,
                ndim, dims, n);
            break;
        case INSIGHT_DTYPE_I16:
            mod_loop_int16(
                (const int16_t*)a->data, a_strides,
                (const int16_t*)b->data, b_strides,
                (int16_t*)out->data, out_strides,
                ndim, dims, n);
            break;
        case INSIGHT_DTYPE_I32:
            mod_loop_int32(
                (const int32_t*)a->data, a_strides,
                (const int32_t*)b->data, b_strides,
                (int32_t*)out->data, out_strides,
                ndim, dims, n);
            break;
        ...
        case INSIGHT_DTYPE_U16:
            mod_loop_uint16(
                (const uint16_t*)a->data, a_strides,
                (const uint16_t*)b->data, b_strides,
                (uint16_t*)out->data, out_strides,
                ndim, dims, n);
            break;
        case INSIGHT_DTYPE_U32:
            mod_loop_uint32(
                (const uint32_t*)a->data, a_strides,
                (const uint32_t*)b->data, b_strides,
                (uint32_t*)out->data, out_strides,
                ndim, dims, n);
            break;
