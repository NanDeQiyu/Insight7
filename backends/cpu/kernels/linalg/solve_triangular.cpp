...
C_Status solve_triangular_kernel_cpu(void** inputs, void** outputs) {
    ...
    if (A->dtype == INSIGHT_DTYPE_F32) {
        ...
        solve_triangular_f64((double*)A->data, (double*)B->data, (double*)out->data,
                             n, nrhs, lower, unit_diag);
    }
    return C_SUCCESS;
}
...
REGISTER_CPU_KERNEL(solve_triangular, INSIGHT_DTYPE_F32, solve_triangular_kernel_cpu);
REGISTER_CPU_KERNEL(solve_triangular, INSIGHT_DTYPE_F64, solve_triangular_kernel_cpu);
