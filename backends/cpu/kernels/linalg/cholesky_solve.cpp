...
static void cholesky_solve_f32(const float* A, const float* B, float* X,
...
extern "C" {
    ...
    C_Status cholesky_solve_kernel_cpu(void** inputs, void** outputs) {
        ...
        if (A->dtype == INSIGHT_DTYPE_F32) {
            cholesky_solve_f32((float*)A->data, (float*)B->data, (float*)out->data, n, nrhs, lower);
        }
        else {
            cholesky_solve_f64((double*)A->data, (double*)B->data, (double*)out->data, n, nrhs, lower);
        }
        return C_SUCCESS;
    }
...
REGISTER_CPU_KERNEL(cholesky_solve, INSIGHT_DTYPE_F32, cholesky_solve_kernel_cpu);
REGISTER_CPU_KERNEL(cholesky_solve, INSIGHT_DTYPE_F64, cholesky_solve_kernel_cpu);
