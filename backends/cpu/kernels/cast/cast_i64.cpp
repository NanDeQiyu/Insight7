// backends/cpu/kernels/cast/cast_i64.cpp
/**
 * @file cast_i64.cpp
 * @brief CPU kernel for casting from i64 to all types.
 *
...
C_Status cast_i64_kernel_cpu(void **inputs, void **outputs) {
  ...
  if (!src || !dst) {
    cpu_set_last_error("cast_i64: null array pointer");
    return C_FAILED;
  }
  ...
  default:
    cpu_set_last_error("cast_i64: unsupported target type");
    return C_FAILED;
  }
...
REGISTER_CPU_KERNEL(cast, INSIGHT_DTYPE_I64, cast_i64_kernel_cpu);
