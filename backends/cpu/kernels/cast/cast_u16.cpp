...
C_Status cast_u16_kernel_cpu(void** inputs, void** outputs) {
    ...
    if (!src || !dst) {
        cpu_set_last_error("cast_u16: null array pointer");
        return C_FAILED;
    }
    ...
    switch (target_dtype) {
        ...
        default:
            cpu_set_last_error("cast_u16: unsupported target type");
            return C_FAILED;
    }
...
REGISTER_CPU_KERNEL(cast, INSIGHT_DTYPE_U16, cast_u16_kernel_cpu);
