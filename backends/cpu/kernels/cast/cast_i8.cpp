// backends/cpu/kernels/cast/cast_i8.cpp
/**
 * @file cast_i8.cpp
 * @brief CPU kernel for casting from i8 to all types.
 *
...
C_Status cast_i8_kernel_cpu(void **inputs, void **outputs) {
  ...
  if (!src || !dst) {
    cpu_set_last_error("cast_i8: null array pointer");
    return C_FAILED;
  }
  ...
  default:
    cpu_set_last_error("cast_i8: unsupported target type");
    return C_FAILED;
  }
...
REGISTER_CPU_KERNEL(cast, INSIGHT_DTYPE_I8, cast_i8_kernel_cpu);
