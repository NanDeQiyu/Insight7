...
C_Status cast_u32_kernel_cpu(void** inputs, void** outputs) {
    ...
    if (!src || !dst) {
        cpu_set_last_error("cast_u32: null array pointer");
        return C_FAILED;
    }
    ...
    switch (target_dtype) {
        ...
        default:
            cpu_set_last_error("cast_u32: unsupported target type");
            return C_FAILED;
    }
...
REGISTER_CPU_KERNEL(cast, INSIGHT_DTYPE_U32, cast_u32_kernel_cpu);
