// backends/cpu/kernels/cast/cast_i16.cpp
/**
 * @file cast_i16.cpp
 * @brief CPU kernel for casting from i16 to all types.
 *
...
C_Status cast_i16_kernel_cpu(void** inputs, void** outputs) {
    ...
    if (!src || !dst) {
        cpu_set_last_error("cast_i16: null array pointer");
        return C_FAILED;
    }
    ...
    switch (target_dtype) {
        ...
        default:
            cpu_set_last_error("cast_i16: unsupported target type");
            return C_FAILED;
    }
...
REGISTER_CPU_KERNEL(cast, INSIGHT_DTYPE_I16, cast_i16_kernel_cpu);
