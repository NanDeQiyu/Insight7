...
REGISTER_CPU_KERNEL(bincount_weighted, INSIGHT_DTYPE_I32, bincount_weighted_kernel_cpu);
REGISTER_CPU_KERNEL(bincount_weighted, INSIGHT_DTYPE_I64, bincount_weighted_kernel_cpu);
