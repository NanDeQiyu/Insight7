...
C_Status quantile_kernel_cpu(void** inputs, void** outputs) {
    ...
    switch (prepared->dtype) {
        case INSIGHT_DTYPE_F32:
            quantile_float((const float*)prepared->data, (double*)out->data, batch_size, reduce_size, q);
            break;
        case INSIGHT_DTYPE_F64:
            quantile_double((const double*)prepared->data, (double*)out->data, batch_size, reduce_size, q);
            break;
        default:
