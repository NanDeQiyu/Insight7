...
static void cumprod_float(const float *src, float *dst, int64_t n,
                          int64_t axis_size, int64_t outer_stride,
...
static void cumprod_double(const double *src, double *dst, int64_t n,
                           int64_t axis_size, int64_t outer_stride,
                           int64_t inner_stride) {
...
static void cumprod_int32(const int32_t *src, int32_t *dst, int64_t n,
                          int64_t axis_size, int64_t outer_stride,
                          int64_t inner_stride) {
...
static void cumprod_int64(const int64_t *src, int64_t *dst, int64_t n,
                          int64_t axis_size, int64_t outer_stride,
                          int64_t inner_stride) {
...
C_Status cumprod_kernel_cpu(void **inputs, void **outputs) {
  ...
  case INSIGHT_DTYPE_F32:
    cumprod_float((const float *)x->data, (float *)out->data, n, axis_size,
                  outer_stride, inner_stride);
    break;
  case INSIGHT_DTYPE_F64:
    cumprod_double((const double *)x->data, (double *)out->data, n, axis_size,
                   outer_stride, inner_stride);
    break;
  case INSIGHT_DTYPE_I32:
    cumprod_int32((const int32_t *)x->data, (int32_t *)out->data, n, axis_size,
                  outer_stride, inner_stride);
    break;
