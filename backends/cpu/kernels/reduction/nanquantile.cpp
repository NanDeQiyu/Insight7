...
static void nanquantile_double(
...
C_Status nanquantile_kernel_cpu(void** inputs, void** outputs) {
    ...
    switch (prepared->dtype) {
        case INSIGHT_DTYPE_F32:
            nanquantile_float((const float*)prepared->data, (float*)out->data, batch_size, reduce_size, q);
            break;
        case INSIGHT_DTYPE_F64:
            nanquantile_double((const double*)prepared->data, (double*)out->data, batch_size, reduce_size, q);
            break;
        default:
