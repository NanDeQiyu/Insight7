...
C_Status fft_c2c_kernel_cpu(void** inputs, void** outputs) {
    ...
    if (x->dtype == INSIGHT_DTYPE_F64 || x->dtype == INSIGHT_DTYPE_C64) {
        ...
        fftw_plan plan = fft_ensure_plan_f64(fft_len, batch_size, direction, FFT_KIND_C2C);
    ...
    // Single precision
        ...
        fftwf_plan plan = fft_ensure_plan_f32(fft_len, batch_size, direction, FFT_KIND_C2C);
