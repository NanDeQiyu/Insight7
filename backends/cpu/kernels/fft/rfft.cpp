...
C_Status rfft_kernel_cpu(void** inputs, void** outputs) {
    ...
    if (x->dtype == INSIGHT_DTYPE_F64) {
        ...
        fftw_plan plan = fft_ensure_plan_f64(fft_len, batch_size, FFTW_FORWARD, FFT_KIND_R2C);
    ...
    // Single precision
        ...
        fftwf_plan plan = fft_ensure_plan_f32(fft_len, batch_size, FFTW_FORWARD, FFT_KIND_R2C);
