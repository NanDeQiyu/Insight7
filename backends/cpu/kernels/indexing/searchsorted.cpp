...
C_Status searchsorted_kernel_cpu(void **inputs, void **outputs) {
  ...
  case INSIGHT_DTYPE_BOOL:
    SEARCHSORTED_DISPATCH(bool);
    break;
  case INSIGHT_DTYPE_U8:
    SEARCHSORTED_DISPATCH(uint8_t);
    break;
  case INSIGHT_DTYPE_U16:
    SEARCHSORTED_DISPATCH(uint16_t);
    break;
  case INSIGHT_DTYPE_U32:
    SEARCHSORTED_DISPATCH(uint32_t);
    break;
  case INSIGHT_DTYPE_U64:
    SEARCHSORTED_DISPATCH(uint64_t);
    break;
  case INSIGHT_DTYPE_I8:
    SEARCHSORTED_DISPATCH(int8_t);
    break;
  case INSIGHT_DTYPE_I16:
    SEARCHSORTED_DISPATCH(int16_t);
    break;
  case INSIGHT_DTYPE_I32:
    SEARCHSORTED_DISPATCH(int32_t);
    break;
  case INSIGHT_DTYPE_I64:
    SEARCHSORTED_DISPATCH(int64_t);
    break;
  ...
  case INSIGHT_DTYPE_F32:
    SEARCHSORTED_DISPATCH(float);
    break;
  case INSIGHT_DTYPE_F64:
    SEARCHSORTED_DISPATCH(double);
    break;
...
REGISTER_CPU_KERNEL(searchsorted, INSIGHT_DTYPE_F8_E4M3,
                    searchsorted_kernel_cpu);
REGISTER_CPU_KERNEL(searchsorted, INSIGHT_DTYPE_F8_E5M2,
                    searchsorted_kernel_cpu);