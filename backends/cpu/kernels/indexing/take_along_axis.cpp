...
#include <complex>
 ...
 // 通用模板实现
template<typename T>
static C_Status take_along_axis_impl(
    InsightArray* out,
    InsightArray* x,
    InsightArray* idx,
    int axis) {
...
REGISTER_CPU_KERNEL(take_along_axis, INSIGHT_DTYPE_BOOL, take_along_axis_kernel_cpu);
REGISTER_CPU_KERNEL(take_along_axis, INSIGHT_DTYPE_U8, take_along_axis_kernel_cpu);
REGISTER_CPU_KERNEL(take_along_axis, INSIGHT_DTYPE_I8, take_along_axis_kernel_cpu);
REGISTER_CPU_KERNEL(take_along_axis, INSIGHT_DTYPE_I16, take_along_axis_kernel_cpu);
REGISTER_CPU_KERNEL(take_along_axis, INSIGHT_DTYPE_I32, take_along_axis_kernel_cpu);
REGISTER_CPU_KERNEL(take_along_axis, INSIGHT_DTYPE_I64, take_along_axis_kernel_cpu);
REGISTER_CPU_KERNEL(take_along_axis, INSIGHT_DTYPE_U16, take_along_axis_kernel_cpu);
REGISTER_CPU_KERNEL(take_along_axis, INSIGHT_DTYPE_U32, take_along_axis_kernel_cpu);
REGISTER_CPU_KERNEL(take_along_axis, INSIGHT_DTYPE_U64, take_along_axis_kernel_cpu);
REGISTER_CPU_KERNEL(take_along_axis, INSIGHT_DTYPE_F16, take_along_axis_kernel_cpu);
REGISTER_CPU_KERNEL(take_along_axis, INSIGHT_DTYPE_BF16, take_along_axis_kernel_cpu);
REGISTER_CPU_KERNEL(take_along_axis, INSIGHT_DTYPE_F32, take_along_axis_kernel_cpu);
REGISTER_CPU_KERNEL(take_along_axis, INSIGHT_DTYPE_F64, take_along_axis_kernel_cpu);
REGISTER_CPU_KERNEL(take_along_axis, INSIGHT_DTYPE_C32, take_along_axis_kernel_cpu);
REGISTER_CPU_KERNEL(take_along_axis, INSIGHT_DTYPE_C64, take_along_axis_kernel_cpu);