    ...
    for (int64_t block = 0; block < num_blocks; ++block) {
        for (int64_t inner = 0; inner < inner_stride; ++inner) {
            for (int64_t k = 0; k < axis_size; ++k) {
                ...
                int64_t dst_idx = block * block_size + ((k + shift) % axis_size) * inner_stride + inner;
    ...
    if (axis == -1) {
        ...
        switch (x->dtype) {
            case INSIGHT_DTYPE_BOOL:
                cpu_roll_1d_impl<bool>((const bool*)x->data, (bool*)out->data, n, shift);
                break;
            case INSIGHT_DTYPE_U8:
                cpu_roll_1d_impl<uint8_t>((const uint8_t*)x->data, (uint8_t*)out->data, n, shift);
                break;
            case INSIGHT_DTYPE_I8:
                cpu_roll_1d_impl<int8_t>((const int8_t*)x->data, (int8_t*)out->data, n, shift);
                break;
            case INSIGHT_DTYPE_I16:
                cpu_roll_1d_impl<int16_t>((const int16_t*)x->data, (int16_t*)out->data, n, shift);
                break;
            case INSIGHT_DTYPE_I32:
                cpu_roll_1d_impl<int32_t>((const int32_t*)x->data, (int32_t*)out->data, n, shift);
                break;
            case INSIGHT_DTYPE_I64:
                cpu_roll_1d_impl<int64_t>((const int64_t*)x->data, (int64_t*)out->data, n, shift);
                break;
            case INSIGHT_DTYPE_U16:
                cpu_roll_1d_impl<uint16_t>((const uint16_t*)x->data, (uint16_t*)out->data, n, shift);
                break;
            case INSIGHT_DTYPE_U32:
                cpu_roll_1d_impl<uint32_t>((const uint32_t*)x->data, (uint32_t*)out->data, n, shift);
                break;
            case INSIGHT_DTYPE_U64:
                cpu_roll_1d_impl<uint64_t>((const uint64_t*)x->data, (uint64_t*)out->data, n, shift);
                break;
            case INSIGHT_DTYPE_F32:
                cpu_roll_1d_impl<float>((const float*)x->data, (float*)out->data, n, shift);
                break;
            case INSIGHT_DTYPE_F64:
                cpu_roll_1d_impl<double>((const double*)x->data, (double*)out->data, n, shift);
                break;
            default:
        ...
        switch (x->dtype) {
            case INSIGHT_DTYPE_BOOL:
                cpu_roll_nd_impl<bool>(
                    (const bool*)x->data, (bool*)out->data,
                    ndim, dims, strides, axis, shift);
                break;
            case INSIGHT_DTYPE_U8:
                cpu_roll_nd_impl<uint8_t>(
                    (const uint8_t*)x->data, (uint8_t*)out->data,
                    ndim, dims, strides, axis, shift);
                break;
            case INSIGHT_DTYPE_I8:
                cpu_roll_nd_impl<int8_t>(
                    (const int8_t*)x->data, (int8_t*)out->data,
                    ndim, dims, strides, axis, shift);
                break;
            case INSIGHT_DTYPE_I16:
                cpu_roll_nd_impl<int16_t>(
                    (const int16_t*)x->data, (int16_t*)out->data,
                    ndim, dims, strides, axis, shift);
                break;
            case INSIGHT_DTYPE_I32:
                cpu_roll_nd_impl<int32_t>(
                    (const int32_t*)x->data, (int32_t*)out->data,
                    ndim, dims, strides, axis, shift);
                break;
            case INSIGHT_DTYPE_I64:
                cpu_roll_nd_impl<int64_t>(
                    (const int64_t*)x->data, (int64_t*)out->data,
                    ndim, dims, strides, axis, shift);
                break;
            case INSIGHT_DTYPE_U16:
                cpu_roll_nd_impl<uint16_t>(
                    (const uint16_t*)x->data, (uint16_t*)out->data,
                    ndim, dims, strides, axis, shift);
                break;
            case INSIGHT_DTYPE_U32:
                cpu_roll_nd_impl<uint32_t>(
                    (const uint32_t*)x->data, (uint32_t*)out->data,
                    ndim, dims, strides, axis, shift);
                break;
            case INSIGHT_DTYPE_U64:
                cpu_roll_nd_impl<uint64_t>(
                    (const uint64_t*)x->data, (uint64_t*)out->data,
                    ndim, dims, strides, axis, shift);
                break;
            case INSIGHT_DTYPE_F32:
                cpu_roll_nd_impl<float>(
                    (const float*)x->data, (float*)out->data,
                    ndim, dims, strides, axis, shift);
                break;
            case INSIGHT_DTYPE_F64:
                cpu_roll_nd_impl<double>(
                    (const double*)x->data, (double*)out->data,
                    ndim, dims, strides, axis, shift);
                break;
            default:
                cpu_set_last_error("roll: unsupported dtype");
