...
extern "C" {
     ...
     */
    void cpu_register_kernel(const char* op_name, int32_t dtype, InsightKernel func);
     ...
     */
    void cpu_sync_kernels(C_Status(*register_fn)(const char*, int32_t, int32_t, InsightKernel));
