...
REGISTER_GPU_KERNEL(isnan, INSIGHT_DTYPE_F32, isnan_kernel_gpu);
REGISTER_GPU_KERNEL(isnan, INSIGHT_DTYPE_F64, isnan_kernel_gpu);
REGISTER_GPU_KERNEL(isnan, INSIGHT_DTYPE_C32, isnan_kernel_gpu);
REGISTER_GPU_KERNEL(isnan, INSIGHT_DTYPE_C64, isnan_kernel_gpu);
