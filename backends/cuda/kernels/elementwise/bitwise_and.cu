...
REGISTER_GPU_KERNEL(bitwise_and, INSIGHT_DTYPE_U8, bitwise_and_kernel_gpu);
REGISTER_GPU_KERNEL(bitwise_and, INSIGHT_DTYPE_U16, bitwise_and_kernel_gpu);
REGISTER_GPU_KERNEL(bitwise_and, INSIGHT_DTYPE_U32, bitwise_and_kernel_gpu);
REGISTER_GPU_KERNEL(bitwise_and, INSIGHT_DTYPE_U64, bitwise_and_kernel_gpu);
REGISTER_GPU_KERNEL(bitwise_and, INSIGHT_DTYPE_I8, bitwise_and_kernel_gpu);
REGISTER_GPU_KERNEL(bitwise_and, INSIGHT_DTYPE_I16, bitwise_and_kernel_gpu);
REGISTER_GPU_KERNEL(bitwise_and, INSIGHT_DTYPE_I32, bitwise_and_kernel_gpu);
REGISTER_GPU_KERNEL(bitwise_and, INSIGHT_DTYPE_I64, bitwise_and_kernel_gpu);
