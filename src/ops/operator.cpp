...
Array operator-(const Array &x) { return negative(x); }

Array operator+(const Array &x) { return x; }

Array operator~(const Array &x) { return bitwise_not(x); }

Array operator!(const Array &x) { return logical_not(x); }
...
Array operator*(const Array &a, const Array &b) { return mul(a, b); }

Array operator/(const Array &a, const Array &b) { return div(a, b); }

Array operator%(const Array &a, const Array &b) { return mod(a, b); }
...
Array operator&(const Array &a, const Array &b) { return bitwise_and(a, b); }

Array operator|(const Array &a, const Array &b) { return bitwise_or(a, b); }

Array operator^(const Array &a, const Array &b) { return bitwise_xor(a, b); }
...
Array operator==(const Array &a, const Array &b) { return equal(a, b); }

Array operator!=(const Array &a, const Array &b) { return not_equal(a, b); }

Array operator<(const Array &a, const Array &b) { return less(a, b); }

Array operator<=(const Array &a, const Array &b) { return less_equal(a, b); }

Array operator>(const Array &a, const Array &b) { return greater(a, b); }

Array operator>=(const Array &a, const Array &b) { return greater_equal(a, b); }
